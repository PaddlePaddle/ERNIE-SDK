...
from utils import create_description, create_questions, erniebot_chat, read_data
...
def generate_candidate_prompts(description, number_of_prompts):
    ...
    for i in range(number_of_prompts):
        ...
        results = erniebot_chat(messages, api_type=args.api_type, access_token=args.access_token)["result"]
        prompts.append(results)
    return prompts


def generate_candidate_questions(description, num_questions=5):
