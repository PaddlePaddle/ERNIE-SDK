...
def fake_erniebot_with_plugin_info():  # withfile plugins
        ...
        "plugin_info": [
            {
                ...
                "plugin_name": "",
                "plugin_req": '{"data":"BUG有100条，需求有100条，使用咨询100条，总共300条反馈","query":"帮我画一个饼状图：8月的用户反馈中，BUG有100条，需求有100条，使用咨询100条，总共300条反馈","chartType":"pie","title":"8月的用户反馈","last_bot_message":""}',  # noqa: E501
                "plugin_resp": "",
                "status": "1",
                "api_id": "eChart.plot",
            },
            {
                ...
                "plugin_name": "",
                "plugin_req": '{"data":"BUG有100条，需求有100条，使用咨询100条，总共300条反馈","query":"帮我画一个饼状图：8月的用户反馈中，BUG有100条，需求有100条，使用咨询100条，总共300条反馈","chartType":"pie","title":"8月的用户反馈","last_bot_message":""}',  # noqa: E501
                "plugin_resp": '{"errCode":0,"errMsg":"success","status":"","actionName":"数据分析","actionContent":"数据分析中"}',  # noqa: E501
                "status": "1",
                "api_id": "eChart.plot",
            },
            {
            ...
            },
            {
                ...
                "plugin_name": "",
                "plugin_req": '{"data":"BUG有100条，需求有100条，使用咨询100条，总共300条反馈","query":"帮我画一个饼状图：8月的用户反馈中，BUG有100条，需求有100条，使用咨询100条，总共300条反馈","chartType":"pie","title":"8月的用户反馈","last_bot_message":""}',  # noqa: E501
                "plugin_resp": '{"errCode":0,"errMsg":"success","status":"","actionName":"数据分析","actionContent":"数据分析中"}\n{"errCode":0,"errMsg":"success","status":"","actionName":"数据分析","actionContent":"数据分析成功"}\n{"errCode":0,"errMsg":"success","status":"","actionName":"图表绘制","actionContent":"图表绘制中"}',  # noqa: E501
                "status": "1",
                "api_id": "eChart.plot",
            },
            {
                ...
                "plugin_name": "",
                "plugin_req": '{"data":"BUG有100条，需求有100条，使用咨询100条，总共300条反馈","query":"帮我画一个饼状图：8月的用户反馈中，BUG有100条，需求有100条，使用咨询100条，总共300条反馈","chartType":"pie","title":"8月的用户反馈","last_bot_message":""}',  # noqa: E501
                "plugin_resp": '{"errCode":0,"errMsg":"success","status":"","actionName":"数据分析","actionContent":"数据分析中"}\n{"errCode":0,"errMsg":"success","status":"","actionName":"数据分析","actionContent":"数据分析成功"}\n{"errCode":0,"errMsg":"success","status":"","actionName":"图表绘制","actionContent":"图表绘制中"}\n{"errCode":0,"errMsg":"success","status":"","actionName":"图表绘制","actionContent":"图表绘制成功"}',  # noqa: E501
                "status": "1",
                "api_id": "eChart.plot",
            },
            {
            ...
            },
            {
                ...
                "plugin_name": "",
                "plugin_req": '{"data":"BUG有100条，需求有100条，使用咨询100条，总共300条反馈","query":"帮我画一个饼状图：8月的用户反馈中，BUG有100条，需求有100条，使用咨询100条，总共300条反馈","chartType":"pie","title":"8月的用户反馈","last_bot_message":""}',  # noqa: E501
                "plugin_resp": '{"errCode":0,"errMsg":"success","status":"","actionName":"数据分析","actionContent":"数据分析中"}\n{"errCode":0,"errMsg":"success","status":"","actionName":"数据分析","actionContent":"数据分析成功"}\n{"errCode":0,"errMsg":"success","status":"","actionName":"图表绘制","actionContent":"图表绘制中"}\n{"errCode":0,"errMsg":"success","status":"","actionName":"图表绘制","actionContent":"图表绘制成功"}\n{"errCode":0,"option":"REMOVED","usage":null}\n{"errCode":0,"errMsg":"success","status":"","actionName":"图表解释","actionContent":"图表解释成功"}\n{"errCode":0,"option":"REMOVED","usage":{"len_answer":0,"len_chart_interpret":161,"len_echarts_dict_str":224,"total_tokens":423}}',  # noqa: E501
                "status": "2",
                "api_id": "eChart.plot",
            },
        ],
        "plugin_metas": [
            {
                ...
                "runtimeMetaInfo": {
                    "function_call": {
                        "arguments": '{"query":"帮我画一个饼状图：8月的用户反馈中，BUG有100条，需求有100条，使用咨询100条，总共300条反馈","title":"8月的用户反馈","chartType":"pie","data":"BUG有100条，需求有100条，使用咨询100条，总共300条反馈"}',  # noqa: E501
                        "name": "eChart.plot",
                        "thoughts": "这是一个图表绘制需求",
                    },
    ...
    rheaders = {
        ...
        "Statement": "AI-generated",
        "X-Aipe-Self-Def": "eb_total_tokens:1047,prompt_tokens:875, echart_total_tokens:423,id:as-4tpm80hx7c",  # noqa: E501
...
def fake_erniebot_with_function_call():
    ...
    rbody = {
        ...
        "function_call": {
            ...
            "thoughts": '用户想要知道"今天是美好的一天"重复三遍是什么，然后生成一个饼状图。首先，我需要使用TextRepeaterNoFileTool工具来获取重复后的文本，然后使用CalculatorTool工具来计算饼状图的数值。任务拆解：[sub-task1: 使用TextRepeaterNoFileTool工具重复文本，sub-task2: 使用CalculatorTool工具计算饼状图]。接下来，我将调用[TextRepeaterNoFileTool]来获取重复后的文本。',  # noqa: E501
