...
def fake_erniebot_with_search_info():
    rcode = 200,
    rbody = {'id': 'as-a4svw1crr0', 'object': 'chat.completion', 'created': 1703492795, 'result': '', 
            'usage': {'prompt_tokens': 1285, 'completion_tokens': 124, 'total_tokens': 1409}, 
            'is_truncated': False, 'finish_reason': 'function_call', 'need_clear_history': False, 
            'search_info': 
                {
                'search_results':[{
                    'index': 1,
    ...
    rheaders = {'Connection': 'keep-alive', 'Content-Security-Policy': 'frame-ancestors https://*.baidu.com/', 
                'Content-Type': 'application/json', 'Date': 'Mon, 25 Dec 2023 08:26:36 GMT', 
                'Server': 'nginx', 'Statement': 'AI-generated', 'Vary': 'Origin',
...
def fake_erniebot_with_plugin_info(): # withfile plugins
    rcode=200, 
    rbody={'id': 'as-4tpm80hx7c', 'object': 'chat.completion', 'created': 1703496289, 
           ...
           'plugin_info': [
                    {'plugin_id': '1004:1.0.3', 'plugin_name': '', 'plugin_req': '{"data":"BUG有100条，需求有100条，使用咨询100条，总共300条反馈","query":"帮我画一个饼状图：8月的用户反馈中，BUG有100条，需求有100条，使用咨询100条，总共300条反馈","chartType":"pie","title":"8月的用户反馈","last_bot_message":""}', 'plugin_resp': '', 'status': '1', 'api_id': 'eChart.plot'},\
                    {'plugin_id': '1004:1.0.3', 'plugin_name': '', 'plugin_req': '{"data":"BUG有100条，需求有100条，使用咨询100条，总共300条反馈","query":"帮我画一个饼状图：8月的用户反馈中，BUG有100条，需求有100条，使用咨询100条，总共300条反馈","chartType":"pie","title":"8月的用户反馈","last_bot_message":""}', 'plugin_resp': '{"errCode":0,"errMsg":"success","status":"","actionName":"数据分析","actionContent":"数据分析中"}', 'status': '1', 'api_id': 'eChart.plot'}, 
                    {'plugin_id': '1004:1.0.3', 'plugin_name': '', 'plugin_req': '{"data":"BUG有100条，需求有100条，使用咨询100条，总共300条反馈","query":"帮我画一个饼状图：8月的用户反馈中，BUG有100条，需求有100条，使用咨询100条，总共300条反馈","chartType":"pie","title":"8月的用户反馈","last_bot_message":""}', 'plugin_resp': '{"errCode":0,"errMsg":"success","status":"","actionName":"数据分析","actionContent":"数据分析中"}', 'status': '1', 'api_id': 'eChart.plot'}, 
                    {'plugin_id': '1004:1.0.3', 'plugin_name': '', 'plugin_req': '{"data":"BUG有100条，需求有100条，使用咨询100条，总共300条反馈","query":"帮我画一个饼状图：8月的用户反馈中，BUG有100条，需求有100条，使用咨询100条，总共300条反馈","chartType":"pie","title":"8月的用户反馈","last_bot_message":""}', 'plugin_resp': '{"errCode":0,"errMsg":"success","status":"","actionName":"数据分析","actionContent":"数据分析中"}\n{"errCode":0,"errMsg":"success","status":"","actionName":"数据分析","actionContent":"数据分析成功"}', 'status': '1', 'api_id': 'eChart.plot'},
                    ...
                    {'plugin_id': '1004:1.0.3', 'plugin_name': '', 'plugin_req': '{"data":"BUG有100条，需求有100条，使用咨询100条，总共300条反馈","query":"帮我画一个饼状图：8月的用户反馈中，BUG有100条，需求有100条，使用咨询100条，总共300条反馈","chartType":"pie","title":"8月的用户反馈","last_bot_message":""}', 'plugin_resp': '{"errCode":0,"errMsg":"success","status":"","actionName":"数据分析","actionContent":"数据分析中"}\n{"errCode":0,"errMsg":"success","status":"","actionName":"数据分析","actionContent":"数据分析成功"}\n{"errCode":0,"errMsg":"success","status":"","actionName":"图表绘制","actionContent":"图表绘制中"}\n{"errCode":0,"errMsg":"success","status":"","actionName":"图表绘制","actionContent":"图表绘制成功"}\n{"errCode":0,"option":"REMOVED","usage":null}\n{"errCode":0,"errMsg":"success","status":"","actionName":"图表解释","actionContent":"图表解释成功"}\n{"errCode":0,"option":"REMOVED","usage":{"len_answer":0,"len_chart_interpret":161,"len_echarts_dict_str":224,"total_tokens":423}}', 'status': '2', 'api_id': 'eChart.plot'}
                    ], 
            'plugin_metas': 
                [{
                    'apiId': 'eChart.plot', 'logoUrl': 'https://echarts.bj.bcebos.com/echarts-logo.png', 
                    'operationId': 'plot', 'pluginId': '1004:1.0.3', 'pluginNameForHuman': 'E言易图', 
                    'pluginNameForModel': 'eChart', 'pluginVersion': '1.0.3', 
                    'runtimeMetaInfo': {'function_call': 
                                        {'arguments': '{"query":"帮我画一个饼状图：8月的用户反馈中，BUG有100条，需求有100条，使用咨询100条，总共300条反馈","title":"8月的用户反馈","chartType":"pie","data":"BUG有100条，需求有100条，使用咨询100条，总共300条反馈"}', 
                                            'name': 'eChart.plot', 'thoughts': '这是一个图表绘制需求'}, 'returnRawFieldName': 'option', 'thoughts': '这是一个图表绘制需求'
                                        }, 
                    'uiMeta': None
                }], 
            'usage': {'prompt_tokens': 875, 'completion_tokens': 172, 'total_tokens': 1047, 
                      'plugins': [{
                            'name': 'eChart', 'parse_tokens': 0, 'abstract_tokens': 0, 'search_tokens': 0, 'total_tokens': 423
                            }]}
        }
    rheaders={'Content-Type': 'application/json; charset=utf-8', 'Statement': 'AI-generated', 
              'X-Aipe-Self-Def': 'eb_total_tokens:1047,prompt_tokens:875, echart_total_tokens:423,id:as-4tpm80hx7c', 
              'Date': 'Mon, 25 Dec 2023 09:24:49 GMT', 'Transfer-Encoding': 'chunked'}
...
def fake_erniebot_with_vanilla_output():
    rcode = 200
    rbody = {'id': 'as-ieb0xfdmsv', 'object': 'chat.completion', 'created': 1703493296, 
            ...
            'is_truncated': False, 'finish_reason': 'normal', 'need_clear_history': False}
    rheaders = {'Connection': 'keep-alive', 'Content-Security-Policy': 'frame-ancestors https://*.baidu.com/',
                'Content-Type': 'application/json', 'Date': 'Mon, 25 Dec 2023 08:34:56 GMT', 
                'Server': 'nginx', 'Statement': 'AI-generated', 'Vary': 'Origin', 
                'X-Frame-Options': 'allow-from https://*.baidu.com/', 
...
async def test_erniebot_with_search_info(fake_erniebot_with_search_info):
    ...
    response = await fake_erniebot.async_chat(messages, )
